        ...
        try:
            ...
            input_data = {
                ...
                "config": {
                    ...
                    "max_iterations": task.max_iterations or 20,
                },
            }
...
async def _initialize_tools(
    project_root: str,
    llm_service,  # 数据流分析工具暂时不用ataFlowAnalysisTool(llm_service), 待检查修改！！
    ...
    from app.services.agent.tools import (
        ...
        # 🔥 新增：导入 Foundry 智能合约沙箱工具
        FoundryCastTool, FoundryTestTool
    )
    ...
    # Verification 工具 (Web3 Exploit 定制版)
    verification_tools = {
        **base_tools,
        # 🔥 核心武器：向沙箱中写入真实的 Solidity 测试脚本
        "write_file": FileWriteTool(project_root),
        # 🔥 核心武器：执行 forge test 闭环测试 PoC 并提取 Profit 战果
        "foundry_test": FoundryTestTool(sandbox_manager, project_root=project_root),
        # 报告工具
